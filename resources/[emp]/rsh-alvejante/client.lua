...
emP = Tunnel.getInterface("rsh-alvejante")
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIAVEIS
-----------------------------------------------------------------------------------------------------------------------------------------
...
-- 					if math.ceil(vehiclespeed) >= 60 and timers <= 0 and payment > 0 then
-- 						idle = 4
-- 						timers = 5
-- 						payment = payment 
-- 						TriggerEvent("Notify","importante","Limite de <b>90 kmh</b> atingido e seu pagamento foi reduzido.",8000)
-- 					end
-- 				end
-- 			end
-- 		end
