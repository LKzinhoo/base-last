...
rsh = Tunnel.getInterface("rsh_dominacao",rsh)
    ...
    while true do
        ...
        for k,v in pairs(locais) do
            ...
            if dist <= 15 and not pegando then
                ...
                if IsControlJustPressed(0, 38) and rsh.permissao(v.perm) and dist <= 1 then
                    if rsh.lootear(k) then
                        pegando = true 
